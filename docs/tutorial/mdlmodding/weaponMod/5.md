...
转换成功后我们就会在原来那三个文件的根目录下得到转换后的mdl文件`XXXXX_conv.mdl`了,我们删掉后面的`_conv`后改名为`ptpov_r97.mdl`即可得到我们需要的文件mdl

![](./img/5/9convfile.png)

## 5.4 打包成北极星mod

然后我们可以打包成北极星mod放进游戏里测试了，至于如何制作打包成北极星mod可以参考官方文档：[Modding Getting Started](https://docs.northstar.tf/Modding/guides/gettingstarted/)

以下是我的测试mod的文件布局，你可以进行参考


```
R2Northstar\mods\HK560.MW22_Fennce45
├── mod
|  └── models
|     └── weapons
|        └── r97
|           └── ptpov_r97.mdl // 此文件就是我们mdlshit转换后的文件
└── mod.json
```

## 5.5 进入游戏测试！
使用北极星启动游戏，装备你修改的武器，进入游戏，看看效果！

![10ingame1](./img/5/10ingame1.png)

![10ingame2](./img/5/10ingame2.png)
